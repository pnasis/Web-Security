...
def access_carlos_account(s, url):
    ...
    r = s.post(login_url, data=login_data, allow_redirects=False, verify=False, proxies=proxies)  #'allow_redirects=False': we drop the redirection to the /login2 endpoint.
